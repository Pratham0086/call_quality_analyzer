...
# Creates all database tables for the project
...
CREATE TABLE IF NOT EXISTS calls (
    ...
    state                VARCHAR,
    media_type_name      VARCHAR DEFAULT 'Call',
...
con.execute("""
CREATE TABLE IF NOT EXISTS qsdd_framework (
...
CREATE TABLE IF NOT EXISTS call_summary (
    ...
    issue_description     TEXT,
    resolution            VARCHAR,
    sentiment_agent       VARCHAR,
    sentiment_customer    VARCHAR,
    overall_score         FLOAT,
    key_moments           TEXT,
    ai_recommendation     TEXT,
    pred_issue_category   VARCHAR,
